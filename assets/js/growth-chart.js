 ...
 * Menampilkan performa segmen: Ekosistem MGI, PT Montana Indo Utama (MIU), dan Montana Sentra Industri (MSI).
 */

let MGIGrowthData = {
  years: ['2020', '2021', '2022', '2023', '2024', '2025', '2026 (P)'],

  // Data Ekosistem Grup MGI (Nilai Aset Terkelola / AUM dalam Miliar IDR)
  mgi: {
    title: 'Ekosistem Grup PT Montana Global Investama',
    subtitle: 'Pertumbuhan Nilai Aset Terkelola & Skala Portofolio Project Investasi Sektor Riil',
    ...
    kpis: [
      ...
      { label: 'Tingkat Ketepatan Bagi Hasil', value: '100%', note: 'Tepat Waktu', icon: 'bi-check-circle-fill', color: 'text-success' },
...
async function initGrowthChart(activeSegment = 'mgi') {
  ...
  if (activeSegment === 'compare') {
    ...
    if (segmentBadge) {
      ...
      segmentBadge.innerText = 'Sinergi Grup';
    }
    ...
    renderGrowthKpis([
      ...
      { label: 'Kemandirian Ketersediaan MSI', value: '72%', note: 'Suku Cadang & Komponen', icon: 'bi-shield-check', color: 'text-primary' }
    ]);
  ...
  if (activeSegment === 'mgi') {
    ...
    datasets = [
      ...
      {
        type: 'line',
        label: 'Nilai Pendanaan Armada (Rp Miliar)',
